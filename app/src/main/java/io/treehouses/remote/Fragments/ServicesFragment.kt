...
class ServicesFragment : BaseServicesFragment(), ServicesListener {
    ...
    private var servicesDetailsFragment: io.treehouses.remote.Fragments.ServicesDetailsFragment? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        tabLayout.addOnTabSelectedListener(object : BaseOnTabSelectedListener<Any?> {
        ...
        override fun handleMessage(msg: Message) {
            when (msg.what) {
                Constants.MESSAGE_READ -> {
                    ...
                    val a: Int = performAction(output, services)
                    if (a == 1) {
                        servicesTabFragment = ServicesTabFragment(services!!)
                        servicesDetailsFragment = io.treehouses.remote.Fragments.ServicesDetailsFragment(services)
