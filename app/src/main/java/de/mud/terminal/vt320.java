...
public abstract class vt320 extends VDUBuffer implements VDUInput {
   ...
   *
   */
  public final static String ID = "$Id: de.mud.terminal.vt320.java 507 2005-10-25 10:14:52Z marcus $";
...
public void setScreenSize(int c, int r, boolean broadcast) {
  ...
  private String terminalID = "de.mud.terminal.vt320";
      ...
      case TSTATE_CSI:
        ...
        switch (c) {
          ...
          case 'c':/* send primary device attributes */
            ...
            String subcode = "";
            if (terminalID.equals("de.mud.terminal.vt320")) subcode = "63;";
